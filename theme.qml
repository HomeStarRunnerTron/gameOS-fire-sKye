...
id: root
    ...
    property var settings: {
        return {
            ...
            VideoPreview:                  api.memory.has("Video preview") ? api.memory.get("Video preview") : "No",
            AllowThumbVideo:               api.memory.has("Allow video thumbnails") ? api.memory.get("Allow video thumbnails") : "No",
